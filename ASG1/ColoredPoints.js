...
function setType(type) {
    ...
    switch (type) {
        case (types.TRIANGLE):
            ...
            document.getElementById('webgl').className = 'triangle-icon';
            break;
        case (types.CIRCLE):
            ...
            document.getElementById('webgl').className = 'circle-icon';
            break;
        case (types.POINT):
        default:
            ...
            document.getElementById('webgl').className = 'square-icon';
            break;
    }
